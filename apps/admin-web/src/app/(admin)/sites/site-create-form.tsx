...
export function SiteCreateForm({ locales }: { locales: LocaleInfo[] }) {
  ...
  const hostnamesValid =
    ...
    effectiveHostnames.every((host) => HOSTNAME_RE.test(host));
  ...
  return (
    <>
      ...
      <Drawer
        ...
        title={t("admin.sites.new")}
        description={t("admin.sites.createHint")}
        width="lg"
        footer={
          <>
            <Button
            ...
            >
              ...
              {hostnamesError ? (
                ...
                <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                  {t("admin.sites.hostnameNormalized", {
                    hostname: effectiveHostnames.join(", "),
                  })}
                </p>
              ) : null}
            ...
            <label className="flex items-start gap-2.5">
              ...
              <span className="text-sm">
                <span className="font-medium">
                  {t("admin.sites.publishNow")}
                </span>
                <span className="mt-0.5 block text-xs text-zinc-500 dark:text-zinc-400">
                  {publish
                    ? t("admin.sites.publishNowHelp", {
                        hostname: effectiveHostnames[0] || "…",
                      })
